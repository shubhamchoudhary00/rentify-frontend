...
const handleSeller=()=>{
  ...
  return (
    ...
    <Photo><img src='/images/home.png' alt='img'/></Photo>
    ...
    <Form.Item
          ...
          <input type='checkbox' id='isSeller' onChange={handleSeller} style={{height:'20px',width:'20px'}} />
          <label htmlFor='isSeller'>Click on the box if you are a seller</label>
          </div>
